    ...
    <div className="w-[95%] lg:w-[70%] m-auto mt-28 text-gray-800 flex flex-col space-y-28">
      <div>
        ...
        <p>
          ...
          how much you invest. Invest in a large variety of stocks on Fusionxace
          and experience unlimited trading volume.
        </p>
      </div>
      <div className="text-center">
        <h1 className="text-4xl">The global leader of profitable trading</h1>
        <p>
          Discover why millions of users from over 140 countries choose to trade
          with Fusionxace
        </p>
        <div className="flex lg:flex-row flex-col lg:space-x-10 mt-10 space-x-0">
